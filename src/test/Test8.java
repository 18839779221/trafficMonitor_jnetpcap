...
public class Test8 {
	...
	public static void main(String[] args) {
		...
		/***************************************************************************
		 * 我们必须将pcap’s data-link-type 映射到 jnetPcap‘s
		 * 协议id，scanner需要这个id数据用来判断packet的第一个header是什么
		 **************************************************************************/
		int id = JRegistry.mapDLTToId(pcap.datalink());
		// JRegistry 是协议的注册表，包括它们的类，运行时id，和相关的绑定，这个全局的注册表包括 绑定表，header
		// scanner表和每个header的数字化id表。同时也提供一些查找和转化功能，比如吧header class 映射为 数字化id
